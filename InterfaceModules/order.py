...
class OrderInterface:
    ...
    def createOrder(self, data_in:dict):
        ...
        sql_tock_out_item = ["GoodsID", "PointOrderGoodsID", "ChangeType", "ChangeAmount", "DataStatus", "CreatedBy"]
        ...
        try:
            for spItem in shoppingCartList:
                ...
                # 商品出库表新增数据，状态均为锁定
                sql_stock_out_values = [spItem.get("GoodsID"), cur.lastrowid, 1, spItem.get("GoodsAmount"), 0, Operator]

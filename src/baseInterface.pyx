...
class BaseRewardPointInterface:
    ...
    def _get_jobrank(self, con: pymssql.Connection, list all_id, bint notemptyflag) -> pd.DataFrame:
    ...
    def _count_educationPoint(self, school_df: pd.DataFrame, str man, list HighSchoolList):
    ...
    def _count_serveragePoint(self, manServing_df: pd.DataFrame, serving_count_time: datetime.datetime, str man,
                              int thisyear):
